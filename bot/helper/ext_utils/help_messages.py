...
/{BotCommands.LeechCommand[0]} or /{BotCommands.LeechCommand[1]}: Начать загрузку в Telegram.
/{BotCommands.QbLeechCommand[0]} or /{BotCommands.QbLeechCommand[1]}: Начать загрузку в Telegram (qBittorrent).
/{BotCommands.YtdlLeechCommand[0]} or /{BotCommands.YtdlLeechCommand[1]}: Начать yt-dlp загрузку в Telegram.
/{BotCommands.UserSetCommand[0]} or /{BotCommands.UserSetCommand[1]} [query]: Пользовательские настройки.
/{BotCommands.BotSetCommand[0]} or /{BotCommands.BotSetCommand[1]} [query]: Настройки бота.
/{BotCommands.CancelTaskCommand[0]} or /{BotCommands.CancelTaskCommand[1]} [gid]: Отменить задачу (в ответ или с GID).
/{BotCommands.CancelAllCommand} [query]: Отменить все задачи.
/{BotCommands.StatusCommand}: Показать статус всех загрузок.
"""
